...
public class ApiQuery {
    private static final String my_api_key = "AIzaSyBPehXESoTPlWEfMgqyAj08RAuwHuCnxt4";
    //    private static String my_api_key="AIzaSSDFSDF8Kv2eP0PM8adf5dSDFysdfas323SD3HA";
